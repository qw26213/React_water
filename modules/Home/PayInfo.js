...
export default React.createClass({
    componentDidMount() {
        document.title = "缴费详情";document.getElementById('pageTit').innerText = "缴费详情";
    },
  render() {
    return (
            <div>
                ...
                <div className="plr15 bgb btbc">
                    <div className="ub-apj h60 bbc">
                            ...
                            <div className="ub-f1 tx-r bc1 ulev0">
                                <div className="red ulev1">-￥30.00</div>
                                <div className="sc1 ulev0 mt05">使用优惠劵后，缴费金额不可更改</div>
                            </div>
                ...
                <div className="ub-ac h50 bgb w100 btc ufix ulb0">
                    ...
                    <div className="bgs3 br05 h40 w80 ub-apc ulev1 ml10 mr15" onclick="toPay()">缴 费</div>
                </div>
            </div>
    );
  }
