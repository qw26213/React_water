...
export default React.createClass({
    getInitialState:function(){
        return{
            ...
            error: null,
            data:null,
            couponHtml:localStorage.couponHtml||"选择使用优惠劵"
        };
    },
   ...
   toCoupon(){
    ...
    componentDidMount() {
        ...
        var that = this;
        window.addEventListener("coupon", function (e) {
          var couponIndex = e.params;
          that.setState({couponHtml: "8折"});
        });
    ...
    <div>
        ...
        <div className="plr15 bgb btbc">
            <div className="ub-apj h45 bbc">
                <div className="ulev0">缴费单位</div>
                <div className="ulev0">{repo.waterCorpName}</div>
            </div>
            <div className="ub-apj h40 bbc">
                <div className="ulev0 bc1">用户名</div>
                <div className="ub-f1 tx-r bc1 ulev0">{repo.name}</div>
            </div>
            <div className="ub-apj h40 bbc">
                <div className="ulev0 bc1">水表号</div>
                <div className="ub-f1 tx-r bc1 ulev0">{repo.userID}</div>
            </div>
            <div className="ub-apj h40 bbc">
                <div className="ulev0 bc1">水费月份</div>
                <div className="ub-f1 tx-r bc1 ulev0">{repo.billSection}</div>
            </div>
        ...
        <div className="plr15 bgb">
            ...
            <div className="plr15 bgb btbc">
                ...
                <div className="ub-apj h40 bbc">
                    <div className="ulev0 bc1">水司余额支付</div>
                    <div className="ub-f1 tx-r bc1 ulev0">￥{repo.balance}</div>
                </div>
                <div className="ub-apj h40">
                    <div className="ulev0 bc1">应付金额</div>
                    <div className="ub-f1 tx-r bc1 ulev0">￥{repo.arrearage}</div>
                </div>
            </div>
